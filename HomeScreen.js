    ...
    <HeaderHome/>
      <ScrollView>
        <View style={{ margin: 10 }}>
          <Text style={{ fontSize: 24, fontWeight: 'bold' }}>Xin chào, Nguyễn Thành Hung</Text>
      ...
      <TouchableOpacity style={{
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 16 }}>
            ...
            <Text style={{ maxWidth: 200 }}> giam 50% gia tri cho cac goi dich vu</Text>
          </Text>
        </View>
        <TouchableOpacity
          style={{
  ...
  return (
    <View style={{ paddingVertical: 15 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <Avatar.Image size={40} source={require('../navigatordemo/icons/vn.png')} />
        <Text
          style={{
            fontSize: 15,
            marginLeft: 5,
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen name='Home' component={HomeScreen} options={{
        drawerIcon: () => (
          <Avatar.Image size={20} source={require('../navigatordemo/icons/vn.png')} />
        ),
      }} />
      <Drawer.Screen name="Lich Hop" component={Lichhop} options={{
        drawerIcon: () => (
          <Avatar.Image size={20} source={require('../navigatordemo/icons/vn.png')} />
        ),
      }} />
      <Drawer.Screen name="Danh ba" component={Danhba} options={{
        drawerIcon: () => (
          <Avatar.Image size={20} source={require('../navigatordemo/icons/vn.png')} />
        ),
      }} />
      <Drawer.Screen name="Tien ich" component={Tienich} options={{
        drawerIcon: () => (
          <Avatar.Image size={20} source={require('../navigatordemo/icons/vn.png')} />
        ),
      }} />
      <Drawer.Screen name="Cai dat" component={Caidat} options={{
        drawerIcon: () => (
          <Avatar.Image size={20} source={require('../navigatordemo/icons/vn.png')} />
        ),
      }} />
  ...
  return (
    <View style={{ margin: 10, backgroundColor: '#FFF', borderRadius: 20 }}>
      <View style={{ margin: 20, alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: 25, marginTop: 5, color: 'green', fontWeight: 'bold' }}>0123456</Text>
        <Text style={{
          fontSize: 16,
          marginTop: 5,
          color: 'blue'
        }}>Chia sẻ cho bạn của chúng tôi ???</Text>
      </View>
